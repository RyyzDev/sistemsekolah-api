...
class Student extends Model
{
    ...
    protected $fillable = [
        'user_id', 'registration_number', 'registration_type', 'registration_path',
        'registration_date', 'status', 'full_name', 'nickname', 'nisn', 'nik',
        'no_kk', 'no_akta_lahir', 'gender', 'birth_place', 'birth_date',
        'religion', 'citizenship', 'nationality', 'address', 'rt', 'rw',
        'dusun', 'kelurahan', 'kecamatan', 'kabupaten_kota', 'province',
        'postal_code', 'latitude', 'longitude', 'residence_type', 'transportation',
        'phone_number', 'mobile_number', 'email', 'height', 'weight', 'blood_type',
        'special_needs', 'special_needs_description', 'disease_history',
        'child_number', 'total_siblings', 'hobby', 'ambition',
        'kps_pkh_recipient', 'kps_pkh_number', 'kip_recipient', 'kip_number',
        'pip_eligible', 'kks_number', 'previous_school_name', 'previous_school_npsn',
        'previous_school_address', 'ijazah_number', 'ijazah_date', 'skhun_number', 'photo'
    ];
